function getBotResponse(input) {
    var response = '';
        ...
        if (input.toLowerCase().includes('hello') || input.toLowerCase().includes('hi')) {
          ...
          response = 'Important Dates<br><br>1. IITM to take admission through IAT for BS - 12 May 2023<br><br>2. NEST Exam Application Portal opens - 1 April 2023<br><br>3. The IAT exam is scheduled on - 17 June 2023, and the registrations would start from - 15 April 2023<br><br>4. NEST Examination - 24 June 2023';
        }
      ...
      // Check user input and generate appropriate response
        ...
        response = "Please, Try again! I'm unable to understand it";
      }
      return response;
}